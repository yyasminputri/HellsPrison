...
public class Level {
	...
	private ArrayList<Skeleton> skels = new ArrayList<>();
	...
	private void loadEntities(int greenValue, int x, int y) {
		switch (greenValue) {
		case SKELETON -> skels.add(new Skeleton(x * Game.TILES_SIZE, y * Game.TILES_SIZE));
	...
	public ArrayList<Skeleton> getSkels() {
		return skels;
	}
